...
void fromblend()
{
  ...
  outputpath = line[0].substring(0, line[0].lastIndexOf(File.separator) + 1);
  println(outputpath);
  rendersname = line[0].substring(line[0].lastIndexOf(File.separator) +1, line[0].indexOf("***"));
  println(rendersname);
  valoption[frame_start_id] = line[0].substring(line[0].indexOf("***") + 3, line[0].lastIndexOf("***"));
  println(valoption[frame_start_id]);
  valoption[frame_end_id] = line[0].substring(line[0].lastIndexOf("***") + 3);
